...
if(event.which === 49){ loopData[event.key].sound.play();}
if(event.which === 81){ loopData[event.key].sound.play();}   
if(event.which === 65){ loopData[event.key].sound.play();}   
if(event.which === 90){ loopData[event.key].sound.play();}
}
